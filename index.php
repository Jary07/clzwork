...
<body background="img/sunrise.jpg">
    ...
    <form action="home.php" method="POST"  class="log">
        ...
        if ($conn->connect_error) {
            die("<p>Connection Lost!</p>" .$conn->connect_error);
        }
        if ($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            if($name=="" || $email== "" || $password==""){
                ...
                echo '<p style="color:green">Signed up Succesfully</p>';
     ...
     ?>
        ...
        <div>
        <label >Name<span id="name-star">*</span>:         </label>
        <input type="text" id="name" name="name">
        </div>
        <div> <label>Email<span id="email-star">*</span>:        </label>
        <input type="email" id="email" name="email"></div>
        <div>
            <div><label>Password<span id="pass-star">*</span>:     </label>
            <input id="pass" type="password" name="password">
            <span><input type="checkbox" id="toggle-pass"><span id="text-tog">show password</span></span></div>
        </div>
        
        <button class="btn">SUBMIT</button>
        <br>
        <span id="a"><a href="login.php">Already Signed up</a></span>
    </div>
</form>
